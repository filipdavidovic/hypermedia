...
module.exports.rulesRegulations = function (req, res) {
    res.render('organization', {
        ...
        content: "<p class='basic-text'>All TU/e rules and regulations can be found on this page. Specific Regulations that are set by the departments, can be found on the pages of the Majors or Master's Programs.</p><p class='basic-text'>The Official Rules and Regulations describe the terms and conditions on which the mentioned Regulation is applicable. The Student Statue describes the rights and duties of the TU/e and students towards each other.</p><h2 class='basic-title align-left'>Codes of conduct</h2><p class='basic-text'>Eindhoven University of Technology places great importance on a number of core values within the organization. That is why at TU/e we commit ourselves to codes of conduct and regulations that provide guidance for working and studying at our university.</p><h2 class='basic-title align-left'>Testing, exam committees, fraud and plagiarism</h2><p class='basic-text'><b>Testing and assessment</b></p><p class='basic-text'>A great variety of testing methods are used at TU/e, such as written tests, presentations, designs or reports that are assessed. The chosen testing method depends on what is being tested and the reason for testing:</p><ul class='basic-text'> <li>Tests to guide the learning process; preparation for the final test</li><li>Testing for certification; have you reached the set final objectives?</li></ul><p class='basic-text'><b>Examination</b></p><p class='basic-text'>At university, we talk of examinations. An examination is a review of the knowledge, understanding and skills of the student, and the assessment of the results of that review, which in Bachelor courses consists of at least two interim tests and a final test in the first year and at least one interim test and a final test after the first year. A large part of the examination result consists of the grade of the final test. Interim tests in the Bachelor courses also always count for a small percentage1 of the final examination grade.</p><p class='basic-text'>The regulations concerning the holding of examinations by TU/e are officially laid down in the TU/e Central Examiniation Regulations 2014 (also applicable in 2015).</p><p class='basic-text'><b>Assessment policy</b></p><p class='basic-text'>Tests must meet certain quality requirements. The conditions to which tests are subject are laid down in the TU/e exam framework.</p><p class='basic-text'>Tests must meet certain quality requirements. The conditions to which tests are subject are laid down in the TU/e exam framework.</p><p class='basic-text'><b>Examination Committee</b></p><p class='basic-text'>An Examination Committee is available for every degree program to ensure the quality of testing. This committee will be called upon by the lecturer in the case of fraud or the suspicion thereof. But students can also call upon this committee if they have any complaints about testing and assessment.</p><p class='basic-text'><b>Fraud and plagiarism</b></p><p class='basic-text'>A TU/e diploma is highly valuable. It is essential that students, the labor market, and society at large are able to trust this value and that TU/e diplomas are obtained legitimately. Students must be in no doubt that there is no place for fraud in an academic program. The Executive Board has ordered that fraud policies be harmonized and kept up-to-date.</p><p class='basic-text'>The TU/e Educational Fraud Policy, adopted on 9 April 2015, takes the TU/e Code of Conduct for Academic Practice as its starting point. A plagiarism prevention policy is part of the TU/e Education Fraud Policy and contains plagiarism detection measures for all Bachelor’s and Master's final projects.</p><h2 class='basic-title align-left'>Transition Procedure Bachelor College</h2><p class='basic-text'>The Bachelor College is making radical changes to the TU/e’s Bachelor’s programs. Students who started their Bachelor’s programs before September 2012 may be affected by the transition procedure Bachelor College.</p>",
        headerActive: "organization",
...
module.exports.academicYear = function (req, res) {
    res.render('study', {
        ...
        content: "<h2 class='basic-title align-left'>Academic Year</h2> <p class='basic-text'>Each academic year is divided into four quartiles. Each quartile consists of 8 weeks of study followed by two weeks of exams. In the academic year agenda, you will find every information about holidays and exams etc. Currently there are two academic year agenda's:</p> <ul class='basic-text'><li><a href='https://static.studiegids.tue.nl/fileadmin/content/centrale_content/STU_files/Plannen/151201_Jaarkalender-2016-2017-NL-EN.pdf'>Year 2016/2017</a></li><li><a href='https://static.studiegids.tue.nl/fileadmin/content/centrale_content/Studeren/Jaarkalender-2017-2018-EN.pdf'>Year 2017/2018</a></li></ul>",
        headerActive: "study",
