...
module.exports.studentForADay = function (req, res) {
    res.render('organization', {
        ...
        '<p class="basic-text">The dates of the Orientation days are set each year by the individual programs.</p>' +
        '<h2 class="basic-title align-left">Would you like to visit an Orientation day?</h2>' +
        '<p class="basic-text">Then <a href="https://start.tue.nl/public/login">login</a> in our registration database, choose the Orientation day of the program you are interested in. The staff of that program will then contact you to invite you to one of the Orientation days.</p>' +
        '<p class="basic-text">Is your preferred orientation day full? New orientation days are planned on a regular basis, so please come back at a later moment to register.</p>',
        headerActive: "organization",
